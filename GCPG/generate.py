...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        Score_min, Score_max, Score_step = 0, 0, 1
        Smi_min, Smi_max, Smi_step = 0, 0, 1
   
        #MW_min, MW_max, MW_step = 325, 425, 20
        #logP_min, logP_max, logP_step = 1, 4, 1
        #QED_min, QED_max, QED_step = 0.4, 0.8, 0.2
        #SAS_min, SAS_max, SAS_step = 1, 5, 1
        #RotaNumBonds_min, RotaNumBonds_max, RotaNumBonds_step = 4, 6, 1
        #Score_min, Score_max, Score_step = 0, 0, 1
        #Smi_min, Smi_max, Smi_step = 0, 0, 1
