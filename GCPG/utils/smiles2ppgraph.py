...
if __name__ == '__main__':
    ...
    with open('../data/canon_train.pickle', 'rb') as f:
        train_smiles = pickle.load(f)

    for i in tqdm(train_smiles[:500], desc="Processing SMILES", ncols=100):
        try:
            g_, smiles_code_res = smiles2ppgraph(i)
        except:
            print(i)
